...
function makeFetch(remoteProxyConnectionString, bindingName, extraHeaders, cfTraceId) {
  return (input, init) => {
...
function makeRemoteProxyStub(remoteProxyConnectionString, bindingName, metadata, cfTraceId) {
...
var Client = class extends WorkerEntrypoint {
  ...
  constructor(ctx, env) {
    super(ctx, env);
    let stub = env.remoteProxyConnectionString ? makeRemoteProxyStub(
